    ...
    <div>
      ...
      </button>
      {
        Object.entries(todoState.lists).map(([listId, list], _i) => (
          <div key={listId} className='flex items-center justify-between p-2 border-b border-gray-200'>
            <div className='flex items-center'>
              <button
                className={`text-gray-500 hover:text-gray-700 ${todoState.activeList === listId ? 'font-semibold' : ''}`}
